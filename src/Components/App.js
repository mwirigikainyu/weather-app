    ...
    return (
      <Wrapper>
        ...
        <Panel>
          ...
          {this.state.cod === 200 &&
            <Details>
              <li>Humidity: <span>{this.state.weather.main.humidity}%</span></li>
              <li>Clouds: <span>{this.state.weather.clouds.all}%</span></li>
              <li>Pressure: <span>{this.state.weather.main.pressure}hPa</span></li>
              <li>Wind: <span>{this.state.weather.wind.speed}m/s</span></li>
            </Details>
          }
        </Panel>
      </Wrapper>
